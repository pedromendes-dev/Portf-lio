              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-4 px-4">
                ...
                <div className="w-full flex items-center justify-between md:hidden">
                  ...
                  <a href="#home" className="flex items-center gap-3">
                    <div className="h-12 w-12 flex-shrink-0 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center">
                ...
                <div className="hidden w-full md:flex items-center justify-around">
                  ...
                  <a href="#home" className="flex items-center gap-3">
                    <div className="h-12 w-12 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center">
                      <span className="text-white font-bold text-lg">P</span>
                    </div>
                    <div className="block">
